...
class Modal extends Component {
  ...
  render() {
    ...
    return (
      <div>
        <Header title={'Структура номеров'} handleCloseModal={this.props.handleCloseModal}/>
				<form onSubmit={() => this.props.handleFormSubmit(this.state.inputs)}>
					{inputs}
					<Button variant="outlined" style={{border: 'none'}} color="primary" onClick={this.handleAddInput}>
						ДОБАВИТЬ
					</Button>
